...
public class Main {
    ...
    public static  <T extends AbstractList<E>, E extends Number>
    T sortList(T arraylist) {
        for (int i = 0; i < arraylist.size(); i++) {
            for (int j = 0; j < arraylist.size(); j++) {
                if(arraylist.get(i).doubleValue()
                        < arraylist.get(j).doubleValue()){
                    E tempVariable;
    ...
    public static <T extends Number> T[] sortArray(T[] tempArr){
        for (int i = 0; i < tempArr.length; i++) {
            for (int j = 0; j < tempArr.length; j++) {
                if(Double.parseDouble(tempArr[i]+"")
                        < Double.parseDouble(tempArr[j]+"")){
    ...
    public static <T extends AbstractList<R>, R extends Number>
